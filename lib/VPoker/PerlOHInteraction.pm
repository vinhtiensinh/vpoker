...
package VPoker::PerlOHInteraction;
...
our @EXPORT =
  qw( gws set_CallbackPointer_to_gws gwt set_CallbackPointer_to_gwt gwp set_CallbackPointer_to_gwp );
our @ISA = qw (Exporter);
...
sub set_CallbackPointer_to_gws {
    ...
    debug_message( "set_CallbackPointer_to_gws:",
...
sub set_CallbackPointer_to_gwt {
    ...
    debug_message( "set_CallbackPointer_to_gwt:",
...
sub set_CallbackPointer_to_gwp {
    ...
    debug_message( "set_CallbackPointer_to_gwp:",
...
sub load_DLL_Callback_Function_gws {
    ...
    debug_message("load_DLL_Callback_Function: $DLL_get_OpenHoldem_Symbol");
...
sub load_DLL_Callback_Function_gwt {
    ...
    debug_message("load_DLL_Callback_Function: $DLL_get_OpenHoldem_TableName");
...
sub get_OpenHoldem_Symbol {
    ...
    if ( defined($DLL_get_OpenHoldem_Symbol) ) {
        $DLL_get_OpenHoldem_Symbol->Call(
            $Pointer_to_OpenHoldem_CallbackFunction_gws,
            $SymbolName, $the_Result );

        #debug_message("Working");
    }
    else {
        debug_message("ERROR: Callback function undefined(gws).");
        $the_Result = 0;
    }

    #debug_message("get_OpenHoldem_Symbol: $the_Result");
...
sub get_OpenHoldem_TableName {
    if ( defined($DLL_get_OpenHoldem_TableName) ) {
        $DLL_get_OpenHoldem_TableName->Call(
            $Pointer_to_OpenHoldem_CallbackFunction_gwt, $the_Result );

        #debug_message("Working");
    }
    else {
        debug_message("ERROR: gwt Callback function undefined(gwt).");
        $the_Result = 0;
    }
...
sub get_OpenHoldem_PlayerName {
    ...
    if ( defined($DLL_get_OpenHoldem_PlayerName) ) {
        $DLL_get_OpenHoldem_PlayerName->Call(
            $Pointer_to_OpenHoldem_CallbackFunction_gwp,
            $PlayerNumber, $the_Result );

        #debug_message("Working");
    }
    else {
        debug_message("ERROR: Callback function undefined(gwp).");
        $the_Result = 0;
    }
...
sub gws {
    ...
    #debug_message("gws: $SymbolName ".$result);
...
sub gwt {
    ...
    #debug_message("gwt: TableName: ".$result);
    return $result;
}
...
sub gwp {
    ...
    #debug_message("gwp: "."$PlayerNumber".". player name: ".$result);
    return $result;
}
